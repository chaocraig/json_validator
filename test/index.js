...
//var schema = require('./test_schema-part');
var schema = require('./cases/schema-formats');
...
var tests = require('./cases/case-formats');
...
var addTest = function(test) {
	...
	one_test[test.desc] = {
        		topic : Validator.validate(test.instance, schema, false),
